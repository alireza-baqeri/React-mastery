...
function TopicDetailsPage() {
  ...
  return (
    <div className="flex items-start justify-center bg-slate-900 p-4 sm:p-6 lg:p-10">
      <article className="w-full max-w-2xl rounded-2xl border border-slate-700 bg-slate-800 p-6 shadow-lg sm:p-8 lg:p-10">
        ...
        <div className="mt-6 flex flex-col gap-3 border-t border-slate-700 pt-5 sm:flex-row sm:items-center sm:justify-between">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 wrap-break-word rounded-lg bg-blue-800 px-4 py-2 text-sm font-medium text-blue-100 transition hover:bg-blue-700 hover:underline sm:text-base"
          >
            Open docs
